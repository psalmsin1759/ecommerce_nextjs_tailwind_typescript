  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="flex flex-col items-center gap-2 mt-2">
        <Link href={'/cart'}>
          <span className="text-xl underline underline-offset-1 cursor-pointer hover:text-primaryColor">
            View Cart
          </span>
        </Link>
        <Link
          href={'/checkout'}
          className="bg-primaryColor px-4 py-2 text-white hover:bg-black"
        >
          <span>Checkout</span>
        </Link>
      </div>
